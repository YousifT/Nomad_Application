    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        title: Column(
          ...
          SliverPadding(padding: EdgeInsets.symmetric(horizontal: 17),
          ...
          child: AspectRatio(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, itemCount) => ClipRRect(
                ...
                child: Material(
        color: Colors.yellow,
        child: InkWell(//toDo "change url based on the clicked image"
          onTap: () {
      ...
      SliverToBoxAdapter(
        child:SingleChildScrollView(
          ...
          child: Row(
            children: 
              List.generate(dummInfo.length, (index) => Padding(
...
class MediumCards extends StatelessWidget {
  const MediumCards({
    super.key, required this.name, required this.location, required this.image, required this.press,
  });
